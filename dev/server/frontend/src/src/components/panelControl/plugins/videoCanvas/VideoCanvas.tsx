 ...
 */
const VideoCanvas: React.FC<VideoCanvasProps> = ({ myId, targetId, isStreaming, onStart, onStop }) => {
  // Base URL for the video proxy server
  const baseUrl = `http://localhost:8080/video/${targetId}?userId=${myId}`;
    ...
    <div className="card video-container">
      ...
      <div className="canvas-wrapper">
        <img 
          ...
          onError={() => setTimeout(handleRefresh, 2000)}
        />
